...
chrome.runtime.onMessage.addListener(
    function(request, _) {
        ...
        if (request.github_is_logged_in) {
...
if (document.querySelector("#two-factor > div > div.border-top.pt-6.mt-6.clearfix > div.col-12.col-md-6.pl-md-3.float-left > form > button")) {
